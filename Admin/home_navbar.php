      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a href="../Signup//login.php" class="btn btn-success"  style="box-shadow: none !important;">Login</a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="../Signup/logout.php" class="btn btn-danger " name="logout" data-toggle="modal" data-target="#loginModal" value="logout">Login</a>
      </div>
    </div>
  </div>
</div>
