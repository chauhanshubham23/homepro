...
<html>
    <head>
        <title>Salon</title>
        <style>
      <?php include './sticky_navbar_css.css'  ?>
            ...
            //     while($product = mysqli_fetch_array($queryfire)){
             ...
             ?>
                    ...
                    <div class="card my-5 bookcard text-center"  >
                        <img src="<?php echo $row['image']; ?>" class="card-img-top" alt="images" height="130">
            ...
            <div class="steps my-3">
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-6 d-flex align-items-center order-1 order-lg-2 rightstepcol">
                      <img src="./man2.png" class="mx-5" alt="Sample image">
                  </div>
                </div>
            </div>
            <!-- end card -->
